...
module.exports = (modifyVars: any, nextConfig: any) => {
  ...
  theme = {
    ...
    "control-padding-horizontal": baseTheme.spacing.sm,
    "control-padding-horizontal-sm": baseTheme.spacing.xs,
    ...
    "shadow-1-up": baseTheme.boxShadow[1].toString(),
    "shadow-1-down": baseTheme.boxShadow[1].toString(),
    "shadow-1-left": baseTheme.boxShadow[1].toString(),
    "shadow-1-right": baseTheme.boxShadow[1].toString(),
    "shadow-2": baseTheme.boxShadow[3].toString(),
