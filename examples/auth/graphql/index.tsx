...
export type TArticlesQueryVariables = {};

export type TArticlesQuery = { __typename?: "query_root" } & {
  article: Array<
    { __typename?: "article" } & Pick<TArticle, "id" | "title" | "content">
  >;
};
...
export type TUserQuery = { __typename?: "query_root" } & {
  user: Array<{ __typename?: "user" } & Pick<TUser, "id" | "username">>;
};
...
export function useArticlesLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<TArticlesQuery, TArticlesQueryVariables>(
    ArticlesDocument,
    baseOptions
  );
}
...
export function useUserQuery(
  ...
  return ApolloReactHooks.useQuery<
    TUserQuery,
    TUserQueryVariables,
    Array<{ __typename?: "user" } & Pick<TUser, "id" | "username">>
