export interface IAntdTheme {
  ...
  collapse: {
    ...
    header: { bg: string; padding: string };
  ...
  layout: {
    ...
    sider: { background: string };
    trigger: { background: string; color: string; height: string };
  ...
  menu: {
    ...
    dark: {
      ...
      highlight: { color: string };
      item: { active: { bg: string }; hover: { bg: string } };
      selected: { item: { icon: { color: string }; text: { color: string } } };
      submenu: { bg: string };
    };
    highlight: { color: string };
    icon: { size: string };
  ...
  table: {
    ...
    row: { hover: { bg: string } };
    selected: { row: { bg: string; color: string; hover: { bg: string } } };
  };
  tabs: {
    active: { color: string };
    bar: { margin: string };
    ...
    highlight: { color: string };
    horizontal: { margin: string; padding: string };
    hover: { color: string };
