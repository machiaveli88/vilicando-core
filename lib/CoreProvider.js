...
function CoreProvider(_a) {
    var children = _a.children, db = _a.db, _b = _a.theme, theme = _b === void 0 ? theme_1.default : _b, _c = _a.renderer, renderer = _c === void 0 ? defaultRenderer : _c, _d = _a.loader, loader = _d === void 0 ? function () { return React.createElement(Loader_1.default, null); } : _d, phrases = _a.phrases, locale = _a.locale;
